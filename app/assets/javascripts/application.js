...
ready = function(){
  $('#talk').on('click', function(event) {
    if ($('#query').val().trim() != ""){
      ...
      $('.simplebar-content').append('<section class="message -right"><div class="nes-balloon from-right"><p>'+$('#query').val()+'</p></div><image src="'+$("#bb_pics").data("path_to_small")+'" alt="BB" class="nes-beardbot"></image></section>');
            ...
            success: function(data) {
              ...
              $.ajax({
                ...
                success: function(data) {
                  ...
                  $('.simplebar-content').append('<section class="message -left"><image src="'+$("#bb_pics").data("path_to_small")+'" alt="BB" class="nes-beardbot"></image><div class="nes-balloon from-left"><p>'+reply+'</p></div></section>');
                  $(".simplebar-content").scrollTop($(".simplebar-content").prop("scrollHeight"));
}
              });
            }
